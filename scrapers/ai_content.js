...
3. **إجباري**: جدول HTML لترتيب الفريقين في الدوري (Standings) قبل هذه المباراة.
4. **إجباري**: جدول HTML للتشكيلة المتوقعة للفريقين (Probable Lineups).
5. **إجباري**: جدول HTML لتاريخ المواجهات المباشرة (Head to Head) آخر 5 مباريات.
6. **إجباري**: جدول HTML لنتائج آخر 5 مباريات لكل فريق (Form).
7. استخدم تنسيق جداول HTML نظيف (<table>, <thead>, <tbody>, <tr>, <th>, <td>).
8. تحليل تقني لنقاط القوة والضعف (استخدم <ul>).
9. خاتمة تحفز القارئ وتتضمن نصاً تشعبياً (Anchor Text) بعبارة "بث مباشر مباريات كرة القدم" يرسل الزائر إلى رابط قناة التيليجرام: "https://t.me/live_football_macth". النص يجب أن يكون جذاباً ومشجعاً للانضمام.
